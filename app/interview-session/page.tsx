      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Candidate: {interviewData.candidateName} | Position:{" "}
        ...
        <TabsContent value="coding">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Have the candidate solve the following problem in the code
                editor.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-6 p-4 bg-muted rounded-md whitespace-pre-wrap">
                {currentQuestion ? (
                  ...
                  <span className="text-red-500 font-medium">
                    No question generated yet. Please go to the Question
